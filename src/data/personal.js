...
export const skills = {
    ...
    "Visual Design": ["Graphic Design", "Branding", "Typography", "Color Theory", "Responsive Design"],
    Specializations: [
        "Mobile App Design",
        "Web Design",
...
export const experience = [
    {
        role: "UI/UX Designer Intern (Operations Intern)",
        company: "Knaptix Ventures Private Limited",
...
export const education = {
    ...
    institution: "Jaypee University of Engineering and Technology, Gwalior",
    period: "2023 – 2027",
};

export const certifications = [
    "UI/UX Design with Figma – Udemy (2025)",
    "User Experience Design with Figma – Udemy (2025)",
    "UI & UX Designs for iOS Apps – Infosys Springboard (2024)",
    "UI/UX for Beginners – Great Learning (2024)",
    "HAckeThor Hackathon – Unstop (2025)",
    "Imagine Hackathon – Unstop (2024)",
];
