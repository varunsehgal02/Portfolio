...
export default function ProjectCard({ project, index }) {
    ...
    return (
        ...
        >
            ...
            <div className={`relative overflow-hidden ${hasMedia ? "" : `h-48 bg-gradient-to-br ${project.gradient}`}`}>
                {hasVideo ? (
                    <video
                        src={project.video}
                        autoPlay
                ...
                <div className="absolute top-4 right-4">
                    <span className="px-3 py-1 rounded-full text-xs font-semibold bg-black/30 backdrop-blur-sm text-white border border-white/20">
