                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="text-text-secondary text-sm">Available for freelance work and internship</span>
                        </motion.div>
                        ...
                        >
                            <DecryptedText
                                text="UI/UX Designer · Graphic Designer · Motion Artist"
                                animateOn="view"
                                speed={40}
                                maxIterations={15}
                                sequential
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6">
                    <SectionHeading
                        ...
                        subtitle="A selection of my recent design work across UI/UX, graphic design, and motion graphics."
                    />
                ...
                <div className="max-w-4xl mx-auto px-6 text-center">
                    ...
                    >
                        ...
                        <p className="text-text-secondary text-lg mb-8 max-w-lg mx-auto">
                            Have an idea? Let&apos;s bring it to life with stunning design and seamless user experiences.
                        </p>
                        <Link
                            href="/contact"
