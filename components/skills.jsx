              ...
              <div className="flex flex-wrap gap-2">
                {category.skills.map((skill, skillIndex) => (
                  <button
                    ...
                    className="px-3 py-1 bg-red-600/20 text-red-300 rounded-full text-sm font-medium hover:bg-red-600/40 transition-all duration-300 cursor-pointer transform hover:scale-110"
                  >
                    {skill}
                  </button>
                ))}
