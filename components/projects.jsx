              ...
              <div className="p-6">
                ...
                <div className="flex gap-2">
                  <a
                    ...
                    className="flex-1 px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded font-semibold transition-all duration-300 transform hover:scale-105 active:scale-95 text-sm text-center"
                  >
                    Live Demo
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 px-4 py-2 border-2 border-red-600 text-red-300 hover:bg-red-600 hover:text-white rounded font-semibold transition-all duration-300 transform hover:scale-105 active:scale-95 text-sm text-center"
                  >
                    View Code
                  </a>
                </div>
