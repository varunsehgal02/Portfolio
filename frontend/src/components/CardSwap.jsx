...
const CardSwap = ({
    ...
    // Container needs enough width/height to hold stacked cards
    const totalCards = childArr.length;
    const containerW = width + (totalCards - 1) * cardDistance;
    const containerH = height + (totalCards - 1) * verticalDistance;
